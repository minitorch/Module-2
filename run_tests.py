...
if len(sys.argv) == 1 or int(sys.argv[1]) == 1:
	...
	print('=================')
	os.system('python -m pytest tests/test_modules.py -m task2_1')
if len(sys.argv) == 1 or int(sys.argv[1]) == 2:
	print('')
	print('=================')
	print('Running test 2')
	print('=================')
	os.system('python -m pytest tests/test_modules.py -m task2_2')
if len(sys.argv) == 1 or int(sys.argv[1]) == 3:
	print('')
	print('=================')
	print('Running test 3')
	print('=================')
	os.system('python -m pytest tests/test_modules.py -m task2_3')
if len(sys.argv) == 1 or int(sys.argv[1]) == 4:
	print('')
	print('=================')
	print('Running test 4')
	print('=================')
	os.system('python -m pytest tests/test_modules.py -m task2_4')
